...
class ModelTransformerTest(test.TestCase):
  ...
  def testReplaceSingleLayerWithSingleLayer_OneOccurrence(self):
    ...
    self.assertEqual(model.input_shape, transformed_model.input_shape)
    self.assertEqual(model.output_shape, transformed_model.output_shape)
  ...
  def testReplaceChainOfLayers_WithSingleLayer(self):
    ...
    self.assertEqual(model_fused.input_shape, transformed_model.input_shape)
    self.assertEqual(model_fused.output_shape, transformed_model.output_shape)
    self._assert_config(
