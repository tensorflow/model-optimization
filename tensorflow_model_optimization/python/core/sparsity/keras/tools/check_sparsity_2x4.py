...
_FILE_PATH = flags.DEFINE_string('model_tflite', None, 'TFLite model file')
...
def print_info(name, shape, sparsity, type, not_applicable):
  """Prints information for the layer."""
  print("{}: shape: {}, sparsity: {}, 2x4: {}, not applicable: {}".\
    format(name, shape, sparsity, type, not_applicable))
